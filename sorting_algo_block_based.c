...
/*   Updated: 2026/05/08 05:47:13 by ecakiray         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 		return ;
// 	if (pos <= len / 2)
// 		rotate_st(a, pos, out, 'a');
// 	else
// 		rev_rotate_st(a, len - pos, out, 'a');
// }

// static int	push_one_block_node(t_dlist *a, t_dlist *b, int start, int end,
// 		t_output *out)
// {
// 	int	middle;
// 	int	value;
